...
async def landing_page() -> Dict:
    ...
    Returns:
        Dict: Landing page content with links
    """
    return {
        "title": "Astral API",
...
@router.get("/conformance", response_model=Dict)
async def conformance() -> Dict:
    """Information about standards that this API conforms to.

    Returns:
        Dict: List of conformance classes
    """
    return {
        "conformsTo": [
...
@router.get("/collections/{collection_id}/items", response_model=Dict)
async def get_features(
    ...
    Returns:
        Union[Dict, Response]: A GeoJSON FeatureCollection or formatted response
    ...
    feature_collection = {
        ...
        "links": [
            ...
            {
                "href": f"/collections/{collection_id}/items?offset={offset + limit}",
                "rel": "next",
                "type": "application/geo+json",
                "title": "Next page",
            },
    ...
    elif f == FormatEnum.json:
        return feature_collection
    else:  # geojson
        return feature_collection


@router.get("/collections/{collection_id}/items/{feature_id}", response_model=Dict)
async def get_feature(
    ...
    """Retrieve a specific feature from a collection.
    ...
    Returns:
        Union[Dict, Response]: A GeoJSON Feature or formatted response
